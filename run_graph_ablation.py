"""Graph-construction ablation suite.
...
def parse_args():
    ...
    p.add_argument(
        ...
        default=0.2,
        help=(
            "Dirichlet α for label skew (smaller α ⇒ stronger imbalance). "
    ...
    p.add_argument(
        ...
        type=float,
        default=2.0,
        help="Upper bound for adaptive τ schedule (default 2.0; passed through to run_experiment).",
    )
    p.add_argument(
        "--tau-gain",
        type=float,
        default=2.0,
        help="Scale for the tanh τ schedule (default 2.0; passed through to run_experiment).",
    )
...
def main():
    ...
    suite_meta = {
        ...
        "matched_random_ablation": (
            ...
            "(spectral_fl.strategy._random_edges_matched_to_knn). Larger gaps vs FedAvg for ours_knn than for ours_random "
        ...
        "trace_contract": (
            ...
            "Authoritative keys are emitted in spectral_fl.strategy from each server round_log row (spectral signals, τ, "
