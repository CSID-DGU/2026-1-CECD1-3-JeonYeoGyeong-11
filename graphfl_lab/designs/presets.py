...
def builtin_designs() -> dict[str, GraphFLDesign]:
    designs = [
        ...
        _design(
            ...
            aggregation=_aggregation("graph_filtered_update", aggregation_target="graph_filtered_update"),
            tags=("core", "graphfl"),
        ...
        _design(
            ...
            aggregation=_aggregation("graph_filtered_weight", aggregation_target="graph_filtered_weight"),
            tags=("compat", "prior-work-proxy"),
