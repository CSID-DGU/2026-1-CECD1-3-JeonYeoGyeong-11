...
│   ├── experimental-design.md        # core experiment, metric, interpretation rule
...
│   └── experiment-results.md         # archived early-result pointer
│
...
| 목적 | 문서 |
|---|---|
| 새 프로젝트 방향을 1분 안에 파악 | [framework/experimental-design.md](framework/experimental-design.md), [framework/claim.md](framework/claim.md) |
...
| 남은 이름/경로 정리 계획이 필요할 때만 확인 | [framework/naming-and-compatibility.md](framework/naming-and-compatibility.md), [framework/cleanup-plan.md](framework/cleanup-plan.md) |
...
| 구분 | 규칙 |
|---|---|
| `framework/` | 현재 claim, 실험 설계, 코드 interface와 직접 맞물리는 문서만 둔다. |
