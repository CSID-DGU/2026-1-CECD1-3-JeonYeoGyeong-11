...
| Concept | Canonical |
|---|---|
| Vision experiment implementation | `spectral_fl/experiments/vision/` |
...
| `spectral_fl/cli/general_*.py` | old imports | `spectral_fl/cli/vision_*.py` |
| `spectral_fl/experiments/general/` | old imports | `experiments/vision/` wrappers |
| `spectral_fl/experiments/suites/general/` | old imports | `experiments/suites/vision/` wrappers |
...
| `spectral_fl/strategies/spectral/` | old strategy imports | `strategies/graphfl/` wrappers |
| `SpectralConflictAwareStrategy` | old class import | `GraphFLDiagnosticStrategy` |
| `spectral_fl` package root | all imports and Flower entrypoints | planned `graphfl_lab` migration |
...
| `spectral_filtered_*` operator outputs | `graph_filtered_*` | aliases exist; lower-level migration pending |
| `spectral_fl` package root | `graphfl_lab` | high-risk migration pending |
...
3. next: spectral_filtered_* lower-level outputs
