...
C5 update docs/commands (in progress: public docs, preset/method specs, suite parsers, and shared CLI aggregation-target choices/help done; reporting/historical reader aliases remain)
