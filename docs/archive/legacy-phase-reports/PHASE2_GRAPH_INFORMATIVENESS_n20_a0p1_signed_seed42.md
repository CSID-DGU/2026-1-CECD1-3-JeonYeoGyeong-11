...
- `./.venv311/Scripts/python.exe run_general_experiment.py --method fedavgm --dataset fashionmnist --partition dirichlet --dirichlet-alpha 0.1 --num-clients 20 --rounds 10 --local-epochs 1 --batch-size 64 --model cnn --lr 0.01 --momentum 0.9 --weight-decay 0.0005 --seed 42 --graph-preset signed_conflict_knn --graph-mode dense --graph-source update --graph-variant identity --graph-smoothing-lambda 0.05 --graph-laplacian-type normalized --graph-zero-diagonal true --compression-dim 256 --compression-seed 0 --graph-seed 0 --server-learning-rate 1.0 --server-momentum 0.9 --train-subset-size 0 --test-subset-size 0 --out-dir experiments_current\phase2_proper_n20_a0p1_signed_seed42 --run-tag phase2_fedavgm_seed42`
- `./.venv311/Scripts/python.exe run_general_experiment.py --method fedavgm --dataset fashionmnist --partition dirichlet --dirichlet-alpha 0.1 --num-clients 20 --rounds 10 --local-epochs 1 --batch-size 64 --model cnn --lr 0.01 --momentum 0.9 --weight-decay 0.0005 --seed 43 --graph-preset signed_conflict_knn --graph-mode dense --graph-source update --graph-variant identity --graph-smoothing-lambda 0.05 --graph-laplacian-type normalized --graph-zero-diagonal true --compression-dim 256 --compression-seed 0 --graph-seed 0 --server-learning-rate 1.0 --server-momentum 0.9 --train-subset-size 0 --test-subset-size 0 --out-dir experiments_current\phase2_proper_n20_a0p1_signed_seed42 --run-tag phase2_fedavgm_seed43`
- `./.venv311/Scripts/python.exe run_general_experiment.py --method fedavgm --dataset fashionmnist --partition dirichlet --dirichlet-alpha 0.1 --num-clients 20 --rounds 10 --local-epochs 1 --batch-size 64 --model cnn --lr 0.01 --momentum 0.9 --weight-decay 0.0005 --seed 44 --graph-preset signed_conflict_knn --graph-mode dense --graph-source update --graph-variant identity --graph-smoothing-lambda 0.05 --graph-laplacian-type normalized --graph-zero-diagonal true --compression-dim 256 --compression-seed 0 --graph-seed 0 --server-learning-rate 1.0 --server-momentum 0.9 --train-subset-size 0 --test-subset-size 0 --out-dir experiments_current\phase2_proper_n20_a0p1_signed_seed42 --run-tag phase2_fedavgm_seed44`
- `./.venv311/Scripts/python.exe run_general_experiment.py --method graph_smooth --dataset fashionmnist --partition dirichlet --dirichlet-alpha 0.1 --num-clients 20 --rounds 10 --local-epochs 1 --batch-size 64 --model cnn --lr 0.01 --momentum 0.9 --weight-decay 0.0005 --seed 42 --graph-preset signed_conflict_knn --graph-mode dense --graph-source update --graph-variant update --graph-smoothing-lambda 0.05 --graph-laplacian-type normalized --graph-zero-diagonal true --compression-dim 256 --compression-seed 0 --graph-seed 0 --server-learning-rate 1.0 --server-momentum 0.9 --train-subset-size 0 --test-subset-size 0 --out-dir experiments_current\phase2_proper_n20_a0p1_signed_seed42 --run-tag phase2_graphsmooth_update_seed42_l0p05`
- `./.venv311/Scripts/python.exe run_general_experiment.py --method graph_smooth --dataset fashionmnist --partition dirichlet --dirichlet-alpha 0.1 --num-clients 20 --rounds 10 --local-epochs 1 --batch-size 64 --model cnn --lr 0.01 --momentum 0.9 --weight-decay 0.0005 --seed 43 --graph-preset signed_conflict_knn --graph-mode dense --graph-source update --graph-variant update --graph-smoothing-lambda 0.05 --graph-laplacian-type normalized --graph-zero-diagonal true --compression-dim 256 --compression-seed 0 --graph-seed 0 --server-learning-rate 1.0 --server-momentum 0.9 --train-subset-size 0 --test-subset-size 0 --out-dir experiments_current\phase2_proper_n20_a0p1_signed_seed42 --run-tag phase2_graphsmooth_update_seed43_l0p05`
- `./.venv311/Scripts/python.exe run_general_experiment.py --method graph_smooth --dataset fashionmnist --partition dirichlet --dirichlet-alpha 0.1 --num-clients 20 --rounds 10 --local-epochs 1 --batch-size 64 --model cnn --lr 0.01 --momentum 0.9 --weight-decay 0.0005 --seed 44 --graph-preset signed_conflict_knn --graph-mode dense --graph-source update --graph-variant update --graph-smoothing-lambda 0.05 --graph-laplacian-type normalized --graph-zero-diagonal true --compression-dim 256 --compression-seed 0 --graph-seed 0 --server-learning-rate 1.0 --server-momentum 0.9 --train-subset-size 0 --test-subset-size 0 --out-dir experiments_current\phase2_proper_n20_a0p1_signed_seed42 --run-tag phase2_graphsmooth_update_seed44_l0p05`
...
| --- | --- | --- | --- | --- | --- |
| fedavgm_baseline | 0.7613 | 0.7664 | 0.7644 | 0.7640 | 0.0021 |
| update | 0.7682 | 0.7625 | 0.7690 | 0.7666 | 0.0029 |
| random | 0.7452 | 0.7554 | 0.7635 | 0.7547 | 0.0075 |
| shuffled | 0.7625 | 0.7594 | 0.7695 | 0.7638 | 0.0042 |
| uniform | 0.7633 | 0.7649 | 0.7652 | 0.7645 | 0.0008 |
| identity | 0.7443 | 0.7690 | 0.7654 | 0.7596 | 0.0109 |
...
- identity - fedavgm (mean): `-0.0045`
- identity - fedavgm (std): `0.0089`
...
_Generated at: 2026-05-11T17:22:59.198232_