"""Aggregation target resolution for the spectral strategy."""
...
def aggregate_target(
    *,
    ...
    raise ValueError(
        ...
        f"{config.target!r}; expected update, spectral_filtered_update, "
        "spectral_filtered_ema_update, weight, or spectral_filtered_weight"
    )
