"""Round and spectral-energy diagnostics for spectral strategies."""
...
def build_round_log(
    *,
    ...
    """Build the full per-round diagnostic row emitted by the spectral strategy."""
    e = conflict["e"]
    e_z = conflict["e_z"]
    ...
    return {
        ...
        **alpha["server_opt_diag"],
        ...
        "spectral_filter_strength": float(config["spectral_filter_strength"]),
        "spectral_filter_strength_config": float(
            config["spectral_filter_strength"]
        ),
