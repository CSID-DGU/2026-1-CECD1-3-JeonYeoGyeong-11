"""Reporting helpers for General-FL suite outputs."""
...
def write_interpretation_md(
    ...
    lines = [
        "# General-FL suite interpretation",
        "",
        "## Run Configuration",
        "",
    ]
...
def duplicate_suite_summaries(
    ...
    """Write legacy alias files alongside canonical general_suite outputs."""
...
def write_summary_markdown(
    ...
    path = out_dir / "general_suite_summary.md"
    lines = [
