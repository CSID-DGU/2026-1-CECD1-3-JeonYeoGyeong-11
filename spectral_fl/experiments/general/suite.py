"""General FL variant-by-seed suite implementation.
...
--------------------------------------------------------------------
  ...
  ours_weight_graph_spectral_weight_agg_knn_k{K}
...
from spectral_fl.experiments.suites.general.reporting import (
    _variant_k_number,
...
from spectral_fl.experiments.suites.general.variants import variant_cmd
...
VARIANTS_EPILOG = """recognized variant tokens:
  ...
  ours_spectral_filtered_magnitude_knn_k1_lp0p5 ours_spectral_filtered_magnitude_knn_k1_lp2p0
  ...
  ours_spectral_filtered_knn_k2 ours_spectral_filtered_uniform
  ours_spectral_filtered_magnitude_knn_k2 ours_spectral_filtered_rbf_knn_k2
...
def collect_run_features(result_obj: Dict[str, Any], method: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "spectral_filter_strength": trace_value("spectral_filter_strength"),
...
def run(args):
    ...
    suite_meta = {
        ...
        "trace_aggregate_semantics": (
            ...
            "mean_update_spectral_filter_* applies to the full update when spectral_filtered_update is used. "
