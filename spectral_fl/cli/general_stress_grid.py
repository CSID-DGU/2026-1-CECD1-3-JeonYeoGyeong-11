"""CLI parser for general stress grid."""
...
import spectral_fl.experiments.general.stress_grid as _experiment
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description=(
            "Run General FL stress suites across num_clients, train/test subset "
    ...
    p.add_argument(
        "--out-dir",
        type=str,
        default="experiments_current/general_stress_grid",
    )
    p.add_argument("--grid-tag", type=str, default="general_stress_grid")
    p.add_argument(
        "--dry-run",
        type=str,
        default="false",
    ...
    p.add_argument(
        ...
        type=str,
        default="false",
        help="If true, reuse a suite when general_suite_summary.csv already exists.",
    )
    p.add_argument(
        "--reuse-existing-results",
        type=str,
        default="true",
        help="Forwarded to run_general_suite.py for partial suite resume.",
    )
    p.add_argument(
        "--max-suites",
        type=int,
