...
import spectral_fl.experiments.vision.client_count_sweep as _experiment
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Sweep vision FL suite runs across num_clients values."
    )
    ...
    p.add_argument(
        "--out-dir",
        type=str,
        default="experiments_current/vision_client_count_sweep",
    )
    p.add_argument("--sweep-tag", type=str, default="vision_client_count_sweep")
