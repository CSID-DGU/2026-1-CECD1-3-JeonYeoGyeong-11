...
import spectral_fl.experiments.general.suite as _experiment
...
def parse_args():
    ...
    p.add_argument(
        ...
        help="Default adaptive-tau signal forwarded to run_general_experiment.",
    )
    p.add_argument(
