...
SCRIPT_PATH = repo_root() / "scripts" / "reports" / "plot_general_convergence.py"


def load_plot_module():
    spec = importlib.util.spec_from_file_location("plot_general_convergence", SCRIPT_PATH)
...
class PlotGeneralConvergenceTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
